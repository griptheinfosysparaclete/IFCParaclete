...
public final class LogicalAndNodeFactory implements NodeFactory<LogicalAndNode> {
    ...
    private abstract static class LogicalAndBaseNode extends LogicalAndNode {
        ...
        protected Object executeAndSpecialize0(int minimumState, VirtualFrame frameValue, Object leftNodeValue, boolean hasRightNodeValue, Object rightNodeValue, String reason) {
            neverPartOfCompilation();
            String message = createInfo0(reason, leftNodeValue, hasRightNodeValue, rightNodeValue);
            if (minimumState < 1 && SLTYPES.isBoolean(leftNodeValue) && (!hasRightNodeValue || SLTYPES.isBoolean(rightNodeValue))) {
                ...
                return this.replace(new LogicalAndBooleanNode(this), message).doBoolean(leftNodeValueCast, hasRightNodeValue, rightNodeValueCast);
            }
            return this.replace(new LogicalAndGenericNode(this), message).executeGeneric0(leftNodeValue, hasRightNodeValue, rightNodeValue);
        }
    ...
    private static final class LogicalAndUninitializedNode extends LogicalAndBaseNode {
        ...
        public Object executeGeneric(VirtualFrame frameValue) {
            ...
            return super.executeAndSpecialize0(0, frameValue, leftNodeValue, hasRightNodeValue, rightNodeValue, "Uninitialized monomorphic");
        }
    ...
    private static final class LogicalAndBooleanNode extends LogicalAndBaseNode {
        ...
        public boolean executeBoolean(VirtualFrame frameValue) throws UnexpectedResultException {
            ...
            try {
                ...
                return SLTYPES.expectBoolean(executeAndSpecialize0(1, frameValue, ex.getResult(), hasRightNodeValue, rightNodeValue, "Expected leftNodeValue instanceof boolean"));
            }
            boolean hasRightNodeValue = super.needsRightNode(leftNodeValue);
            ...
            if (hasRightNodeValue) {
                try {
                    ...
                    transferToInterpreter();
                    return SLTYPES.expectBoolean(executeAndSpecialize0(1, frameValue, leftNodeValue, hasRightNodeValue, ex.getResult(), "Expected rightNodeValue instanceof boolean"));
                }
            }
        ...
        public Object executeEvaluated(VirtualFrame frameValue, Object leftNodeValueEvaluated) {
            ...
            try {
                ...
                return executeAndSpecialize0(1, frameValue, ex.getResult(), hasRightNodeValue, rightNodeValue, "Expected leftNodeValue instanceof boolean");
            }
            boolean hasRightNodeValue = super.needsRightNode(leftNodeValue);
            boolean rightNodeValue = false;
            if (hasRightNodeValue) {
                try {
                    ...
                    transferToInterpreter();
                    return executeAndSpecialize0(1, frameValue, leftNodeValue, hasRightNodeValue, ex.getResult(), "Expected rightNodeValue instanceof boolean");
                }
            }
            return super.doBoolean(leftNodeValue, hasRightNodeValue, rightNodeValue);
        }
