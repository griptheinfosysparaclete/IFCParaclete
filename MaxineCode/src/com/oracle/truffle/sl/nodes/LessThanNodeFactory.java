...
public final class LessThanNodeFactory implements NodeFactory<LessThanNode> {
    ...
    private abstract static class LessThanBaseNode extends LessThanNode {
        ...
        protected Object executeAndSpecialize0(int minimumState, VirtualFrame frameValue, Object leftNodeValue, Object rightNodeValue, String reason) {
            ...
            if (minimumState < 1 && SLTYPES.isInteger(leftNodeValue) && SLTYPES.isInteger(rightNodeValue)) {
                ...
                return this.replace(new LessThanIntNode(this), message).doInteger(leftNodeValueCast, rightNodeValueCast);
            }
            if (minimumState < 2 && SLTYPES.isBigInteger(leftNodeValue) && SLTYPES.isBigInteger(rightNodeValue)) {
                ...
                return this.replace(new LessThanBigIntegerNode(this), message).doBigInteger(leftNodeValueCast, rightNodeValueCast);
            }
            if (minimumState < 3 && super.isString(leftNodeValue, rightNodeValue)) {
                return this.replace(new LessThanObjectNode(this), message).doString(leftNodeValue, rightNodeValue);
            }
            if (this.next0 == null && minimumState > 0) {
                ...
                this.setNext0(new LessThanUninitializedNode(this));
                ...
                if (this.next0 != null) {
                    ...
                    do {
                        ...
                        root = root.getParent();
                    } while (!(root instanceof LessThanPolymorphicNode));
                }
                return root.replace(new LessThanGenericNode((LessThanBaseNode) root), message).executeGeneric0(leftNodeValue, rightNodeValue);
            }
        }
    ...
    private static final class LessThanUninitializedNode extends LessThanBaseNode {
        ...
        protected Object executeCachedGeneric0(VirtualFrame frameValue, Object leftNodeValue, Object rightNodeValue) {
            ...
            if (depth > 2) {
                return root.replace(new LessThanGenericNode((LessThanBaseNode) root), "Polymorphic limit reached (2)").executeGeneric0(leftNodeValue, rightNodeValue);
            } else {
                setNext0(new LessThanUninitializedNode(this));
                Object result = executeAndSpecialize0(0, frameValue, leftNodeValue, rightNodeValue, "Uninitialized polymorphic (" + depth + "/2)");
                if (this.next0 != null) {
                    ((LessThanPolymorphicNode) root).optimizeTypes();
                }
                return result;
            }
        }
    ...
    private static final class LessThanIntNode extends LessThanBaseNode {
        ...
        public boolean executeBoolean(VirtualFrame frameValue) throws UnexpectedResultException {
            ...
            try {
                ...
                transferToInterpreter();
                Object rightNodeValue = this.rightNode.executeGeneric(frameValue);
                return SLTYPES.expectBoolean(executeAndSpecialize0(1, frameValue, ex.getResult(), rightNodeValue, "Expected leftNodeValue instanceof int"));
            }
            int rightNodeValue;
            try {
                ...
                transferToInterpreter();
                return SLTYPES.expectBoolean(executeAndSpecialize0(1, frameValue, leftNodeValue, ex.getResult(), "Expected rightNodeValue instanceof int"));
            }
    ...
    private static final class LessThanBigIntegerNode extends LessThanBaseNode {
        ...
        public boolean executeBoolean(VirtualFrame frameValue) throws UnexpectedResultException {
            ...
            try {
                ...
                transferToInterpreter();
                Object rightNodeValue = this.rightNode.executeGeneric(frameValue);
                return SLTYPES.expectBoolean(executeAndSpecialize0(2, frameValue, ex.getResult(), rightNodeValue, "Expected leftNodeValue instanceof BigInteger"));
            }
            ...
            try {
                ...
                transferToInterpreter();
                return SLTYPES.expectBoolean(executeAndSpecialize0(2, frameValue, leftNodeValue, ex.getResult(), "Expected rightNodeValue instanceof BigInteger"));
            }
    ...
    private static final class LessThanObjectNode extends LessThanBaseNode {
        ...
        public boolean executeBoolean(VirtualFrame frameValue) throws UnexpectedResultException {
            ...
            transferToInterpreter();
            return SLTYPES.expectBoolean(executeAndSpecialize0(3, frameValue, leftNodeValue, rightNodeValue, "One of guards [isString] failed"));
        }
        ...
        public Object executeEvaluated(VirtualFrame frameValue, Object leftNodeValueEvaluated) {
            ...
            transferToInterpreter();
            return executeAndSpecialize0(3, frameValue, leftNodeValue, rightNodeValue, "One of guards [isString] failed");
        }
