...
public final class TernaryNodeFactory implements NodeFactory<TernaryNode> {
    ...
    private abstract static class TernaryBaseNode extends TernaryNode {
        ...
        protected Object executeAndSpecialize0(int minimumState, VirtualFrame frameValue, boolean conditionNodeValue, boolean hasIfPartNodeValue, Object ifPartNodeValue, boolean hasElsePartNodeValue,
                    Object elsePartNodeValue, String reason) {
            ...
            if (minimumState < 3) {
                if (minimumState < 1 && (!hasIfPartNodeValue || SLTYPES.isInteger(ifPartNodeValue)) && (!hasElsePartNodeValue || SLTYPES.isInteger(elsePartNodeValue))) {
                    ...
                    return this.replace(new TernaryIntNode(this), message).doInteger(conditionNodeValue, hasIfPartNodeValue, ifPartNodeValueCast, hasElsePartNodeValue, elsePartNodeValueCast);
                }
                if (minimumState < 2 && (!hasIfPartNodeValue || SLTYPES.isBigInteger(ifPartNodeValue)) && (!hasElsePartNodeValue || SLTYPES.isBigInteger(elsePartNodeValue))) {
                    ...
                    return this.replace(new TernaryBigIntegerNode(this), message).doBigInteger(conditionNodeValue, hasIfPartNodeValue, ifPartNodeValueCast, hasElsePartNodeValue, elsePartNodeValueCast);
                }
                return this.replace(new TernaryObjectNode(this), message).doObject(conditionNodeValue, hasIfPartNodeValue, ifPartNodeValue, hasElsePartNodeValue, elsePartNodeValue);
            }
            throw new UnsupportedOperationException(createInfo0("Unsupported values", conditionNodeValue, hasIfPartNodeValue, ifPartNodeValue, hasElsePartNodeValue, elsePartNodeValue));
            // unreachable Generic
        }
    ...
    private static final class TernaryUninitializedNode extends TernaryBaseNode {
        ...
        public Object executeGeneric(VirtualFrame frameValue) {
            ...
            return super.executeAndSpecialize0(0, frameValue, conditionNodeValue, hasIfPartNodeValue, ifPartNodeValue, hasElsePartNodeValue, elsePartNodeValue, "Uninitialized monomorphic");
        }
        ...
        public int executeInteger(VirtualFrame frameValue) throws UnexpectedResultException {
            ...
            if (hasIfPartNodeValue) {
                try {
                    ...
                    return SLTYPES.expectInteger(executeAndSpecialize0(1, frameValue, conditionNodeValue, hasIfPartNodeValue, ex.getResult(), hasElsePartNodeValue, elsePartNodeValue, "Expected ifPart"
                                + "NodeValue instanceof int"));
                }
            }
            boolean hasElsePartNodeValue = super.needsElsePart(conditionNodeValue, hasIfPartNodeValue, ifPartNodeValue);
            ...
            if (hasElsePartNodeValue) {
                try {
                    ...
                    transferToInterpreter();
                    return SLTYPES.expectInteger(executeAndSpecialize0(1, frameValue, conditionNodeValue, hasIfPartNodeValue, ifPartNodeValue, hasElsePartNodeValue, ex.getResult(), "Expected elsePart"
                                + "NodeValue instanceof int"));
                }
            }
        ...
        public Object executeEvaluated(VirtualFrame frameValue, Object conditionNodeValueEvaluated) {
            ...
            if (hasIfPartNodeValue) {
                try {
                    ...
                    return executeAndSpecialize0(1, frameValue, conditionNodeValue, hasIfPartNodeValue, ex.getResult(), hasElsePartNodeValue, elsePartNodeValue, "Expected ifPartNodeValue instanceof i"
                                + "nt");
                }
            }
            boolean hasElsePartNodeValue = super.needsElsePart(conditionNodeValue, hasIfPartNodeValue, ifPartNodeValue);
            ...
            if (hasElsePartNodeValue) {
                try {
                    ...
                    transferToInterpreter();
                    return executeAndSpecialize0(1, frameValue, conditionNodeValue, hasIfPartNodeValue, ifPartNodeValue, hasElsePartNodeValue, ex.getResult(), "Expected elsePartNodeValue instanceof i"
                                + "nt");
                }
            }
            return super.doInteger(conditionNodeValue, hasIfPartNodeValue, ifPartNodeValue, hasElsePartNodeValue, elsePartNodeValue);
        ...
        public BigInteger executeBigInteger(VirtualFrame frameValue) throws UnexpectedResultException {
            ...
            if (hasIfPartNodeValue) {
                try {
                    ...
                    return SLTYPES.expectBigInteger(executeAndSpecialize0(2, frameValue, conditionNodeValue, hasIfPartNodeValue, ex.getResult(), hasElsePartNodeValue, elsePartNodeValue, "Expected ifP"
                                + "artNodeValue instanceof BigInteger"));
                }
            }
            boolean hasElsePartNodeValue = super.needsElsePart(conditionNodeValue, hasIfPartNodeValue, ifPartNodeValue);
            ...
            if (hasElsePartNodeValue) {
                try {
                    ...
                    transferToInterpreter();
                    return SLTYPES.expectBigInteger(executeAndSpecialize0(2, frameValue, conditionNodeValue, hasIfPartNodeValue, ifPartNodeValue, hasElsePartNodeValue, ex.getResult(), "Expected elseP"
                                + "artNodeValue instanceof BigInteger"));
                }
            }
        ...
        public Object executeEvaluated(VirtualFrame frameValue, Object conditionNodeValueEvaluated) {
            ...
            if (hasIfPartNodeValue) {
                try {
                    ...
                    return executeAndSpecialize0(2, frameValue, conditionNodeValue, hasIfPartNodeValue, ex.getResult(), hasElsePartNodeValue, elsePartNodeValue, "Expected ifPartNodeValue instanceof B"
                                + "igInteger");
                }
            }
            boolean hasElsePartNodeValue = super.needsElsePart(conditionNodeValue, hasIfPartNodeValue, ifPartNodeValue);
            ...
            if (hasElsePartNodeValue) {
                try {
                    ...
                    transferToInterpreter();
                    return executeAndSpecialize0(2, frameValue, conditionNodeValue, hasIfPartNodeValue, ifPartNodeValue, hasElsePartNodeValue, ex.getResult(), "Expected elsePartNodeValue instanceof B"
                                + "igInteger");
                }
            }
            return super.doBigInteger(conditionNodeValue, hasIfPartNodeValue, ifPartNodeValue, hasElsePartNodeValue, elsePartNodeValue);
