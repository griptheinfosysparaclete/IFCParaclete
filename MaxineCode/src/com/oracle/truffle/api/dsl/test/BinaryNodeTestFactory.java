        ...
        private abstract static class AddBaseNode extends AddNode {
            ...
            protected Object executeAndSpecialize0(int minimumState, VirtualFrame frameValue, Object leftValue, Object rightValue, String reason) {
                ...
                if (minimumState < 1 && SIMPLETYPES.isInteger(leftValue) && SIMPLETYPES.isInteger(rightValue)) {
                    ...
                    return this.replace(new AddIntNode(this), message).add(leftValueCast, rightValueCast);
                }
                return this.replace(new AddGenericNode(this), message).executeGeneric0(leftValue, rightValue);
            }
