    ...
    static final class StrFactory {
        ...
        static final class StrAccessContextFactory implements NodeFactory<BuiltinNode> {
            ...
            public BuiltinNode createNode(Object... arguments) {
                if (arguments.length == 2 && (arguments[0] == null || arguments[0] instanceof ValueNode[]) && (arguments[1] == null || arguments[1] instanceof Context)) {
                    return create((ValueNode[]) arguments[0], (Context) arguments[1]);
                } else {
            ...
            public List<List<Class<?>>> getNodeSignatures() {
                return asList(Arrays.<Class<?>>asList(ValueNode[].class, Context.class));
            }
            ...
            static BuiltinNode create(ValueNode[] children, Context context) {
                return new StrAccessContextDefaultNode(children, context);
            }
            ...
            private abstract static class StrAccessContextBaseNode extends BuiltinNode {
                ...
                StrAccessContextBaseNode(ValueNode[] children, Context context) {
                    super();
            ...
            private static final class StrAccessContextDefaultNode extends StrAccessContextBaseNode {
                ...
                StrAccessContextDefaultNode(ValueNode[] children, Context context) {
        ...
        static final class StrConcatFactory implements NodeFactory<BuiltinNode> {
            ...
            static BuiltinNode create(ValueNode[] children, Context context) {
                return new StrConcatUninitializedNode(children, context);
            }
            ...
            private abstract static class StrConcatBaseNode extends BuiltinNode {
                ...
                StrConcatBaseNode(ValueNode[] children, Context context) {
                    super();
                    this.children = adoptChildren(children);
                    this.context = context;
                }
                ...
                protected Object executeAndSpecialize0(int minimumState, VirtualFrame frameValue, Object childrenValue0, Object childrenValue1, String reason) {
                    neverPartOfCompilation();
                    String message = createInfo0(reason, childrenValue0, childrenValue1);
                    if (minimumState < 1 && SIMPLETYPES.isStr(childrenValue0) && SIMPLETYPES.isStr(childrenValue1)) {
                        Str childrenValue0Cast = SIMPLETYPES.asStr(childrenValue0);
                        Str childrenValue1Cast = SIMPLETYPES.asStr(childrenValue1);
                        this.replace(new StrConcatStrNode(this), message);
                        return childrenValue0Cast.concat(childrenValue1Cast);
                    }
                    return this.replace(new StrConcatGenericNode(this), message).executeGeneric0(childrenValue0, childrenValue1);
                }
            ...
            private static final class StrConcatUninitializedNode extends StrConcatBaseNode {
                ...
                StrConcatUninitializedNode(ValueNode[] children, Context context) {
                    super(children, context);
                }
                ...
                public Object execute(VirtualFrame frameValue) {
                    ...
                    return super.executeAndSpecialize0(0, frameValue, childrenValue0, childrenValue1, "Uninitialized monomorphic");
                }
            ...
            private static final class StrConcatStrNode extends StrConcatBaseNode {
                ...
                public Str executeStr(VirtualFrame frameValue) throws UnexpectedResultException {
                    ...
                    try {
                        ...
                        transferToInterpreter();
                        Object childrenValue1 = this.children[1].execute(frameValue);
                        return SIMPLETYPES.expectStr(executeAndSpecialize0(1, frameValue, ex.getResult(), childrenValue1, "Expected childrenValue0 instanceof Str"));
                    }
                    Str childrenValue1;
                    try {
                        ...
                        transferToInterpreter();
                        return SIMPLETYPES.expectStr(executeAndSpecialize0(1, frameValue, childrenValue0, ex.getResult(), "Expected childrenValue1 instanceof Str"));
                    }
        ...
        static final class StrLengthFactory implements NodeFactory<BuiltinNode> {
            ...
            static BuiltinNode create(ValueNode[] children, Context context) {
                return new StrLengthUninitializedNode(children, context);
            }
            ...
            private abstract static class StrLengthBaseNode extends BuiltinNode {
                ...
                StrLengthBaseNode(ValueNode[] children, Context context) {
                    super();
                    this.children = adoptChildren(children);
                    this.context = context;
                }
                ...
                @SuppressWarnings("unused")
                protected Object executeAndSpecialize0(int minimumState, VirtualFrame frameValue, Object childrenValue0, String reason) {
                    neverPartOfCompilation();
                    String message = createInfo0(reason, childrenValue0);
                    if (minimumState < 1 && SIMPLETYPES.isStr(childrenValue0)) {
                        Str childrenValue0Cast = SIMPLETYPES.asStr(childrenValue0);
                        this.replace(new StrLengthStrNode(this), message);
                        return childrenValue0Cast.length();
                    }
                    return this.replace(new StrLengthGenericNode(this), message).executeGeneric0(childrenValue0);
                }
            ...
            private static final class StrLengthUninitializedNode extends StrLengthBaseNode {
                ...
                StrLengthUninitializedNode(ValueNode[] children, Context context) {
                    super(children, context);
                }
                ...
                public Object execute(VirtualFrame frameValue) {
                    transferToInterpreter();
                    Object childrenValue0 = this.children[0].execute(frameValue);
                    return super.executeAndSpecialize0(0, frameValue, childrenValue0, "Uninitialized monomorphic");
                }
            ...
            private static final class StrLengthStrNode extends StrLengthBaseNode {
                ...
                public int executeInt(VirtualFrame frameValue) throws UnexpectedResultException {
                    ...
                    try {
                        ...
                        transferToInterpreter();
                        return SIMPLETYPES.expectInteger(executeAndSpecialize0(1, frameValue, ex.getResult(), "Expected childrenValue0 instanceof Str"));
                    }
        ...
        static final class StrSubstrFactory implements NodeFactory<BuiltinNode> {
            ...
            static BuiltinNode create(ValueNode[] children, Context context) {
                return new StrSubstrUninitializedNode(children, context);
            }
            ...
            private abstract static class StrSubstrBaseNode extends BuiltinNode {
                ...
                StrSubstrBaseNode(ValueNode[] children, Context context) {
                    super();
                    this.children = adoptChildren(children);
                    this.context = context;
                }
                ...
                @SuppressWarnings("unused")
                protected Str executeAndSpecialize0(int minimumState, VirtualFrame frameValue, Object childrenValue0, Object childrenValue1, Object childrenValue2, String reason) {
                    neverPartOfCompilation();
                    String message = createInfo0(reason, childrenValue0, childrenValue1, childrenValue2);
                    if (minimumState < 1 && SIMPLETYPES.isStr(childrenValue0) && SIMPLETYPES.isInteger(childrenValue1) && SIMPLETYPES.isInteger(childrenValue2)) {
                        Str childrenValue0Cast = SIMPLETYPES.asStr(childrenValue0);
                        int childrenValue1Cast = SIMPLETYPES.asInteger(childrenValue1);
                        int childrenValue2Cast = SIMPLETYPES.asInteger(childrenValue2);
                        this.replace(new StrSubstrStrIntNode(this), message);
                        return childrenValue0Cast.substr(childrenValue1Cast, childrenValue2Cast);
                    }
                    return this.replace(new StrSubstrGenericNode(this), message).executeGeneric0(childrenValue0, childrenValue1, childrenValue2);
                }
            ...
            private static final class StrSubstrUninitializedNode extends StrSubstrBaseNode {
                ...
                StrSubstrUninitializedNode(ValueNode[] children, Context context) {
                    super(children, context);
                }
                ...
                public Str executeStr(VirtualFrame frameValue) throws UnexpectedResultException {
                    ...
                    return super.executeAndSpecialize0(0, frameValue, childrenValue0, childrenValue1, childrenValue2, "Uninitialized monomorphic");
                }
            ...
            private static final class StrSubstrStrIntNode extends StrSubstrBaseNode {
                ...
                public Str executeStr(VirtualFrame frameValue) throws UnexpectedResultException {
                    ...
                    try {
                        ...
                        Object childrenValue1 = this.children[1].execute(frameValue);
                        Object childrenValue2 = this.children[2].execute(frameValue);
                        return executeAndSpecialize0(1, frameValue, ex.getResult(), childrenValue1, childrenValue2, "Expected childrenValue0 instanceof Str");
                    }
                    int childrenValue1;
                    try {
                        ...
                        transferToInterpreter();
                        Object childrenValue2 = this.children[2].execute(frameValue);
                        return executeAndSpecialize0(1, frameValue, childrenValue0, ex.getResult(), childrenValue2, "Expected childrenValue1 instanceof int");
                    }
                    int childrenValue2;
                    try {
                        ...
                        transferToInterpreter();
                        return executeAndSpecialize0(1, frameValue, childrenValue0, childrenValue1, ex.getResult(), "Expected childrenValue2 instanceof int");
                    }
