...
import com.oracle.truffle.api.dsl.test.ExecuteEvaluatedTest.TestEvaluatedGeneration;
...
public final class ExecuteEvaluatedTestFactory {
    ...
    public static List<NodeFactory<? extends ValueNode>> getFactories() {
        return asList(EvaluatedNodeFactory.getInstance(), UseEvaluatedNodeFactory.getInstance(), DoubleEvaluatedNodeFactory.getInstance(), UseDoubleEvaluatedNodeFactory.getInstance(),
                    TestEvaluatedGenerationFactory.getInstance());
    }
    ...
    static final class EvaluatedNodeFactory implements NodeFactory<EvaluatedNode> {
        ...
        private abstract static class EvaluatedBaseNode extends EvaluatedNode {
            ...
            protected Object executeAndSpecialize0(int minimumState, VirtualFrame frameValue, Object expValue, String reason) {
                neverPartOfCompilation();
                String message = createInfo0(reason, expValue);
                if (minimumState < 1 && SIMPLETYPES.isInteger(expValue)) {
                    int expValueCast = SIMPLETYPES.asInteger(expValue);
                    return this.replace(new EvaluatedIntNode(this), message).doExecuteWith(expValueCast);
                }
                return this.replace(new EvaluatedGenericNode(this), message).executeGeneric0(expValue);
            }
        ...
        private static final class EvaluatedUninitializedNode extends EvaluatedBaseNode {
            ...
            public Object execute(VirtualFrame frameValue) {
                ...
                return super.executeAndSpecialize0(0, frameValue, expValue, "Uninitialized monomorphic");
            }
        ...
        private static final class EvaluatedIntNode extends EvaluatedBaseNode {
            ...
            public int executeInt(VirtualFrame frameValue) throws UnexpectedResultException {
                ...
                try {
                    ...
                    transferToInterpreter();
                    return SIMPLETYPES.expectInteger(executeAndSpecialize0(1, frameValue, ex.getResult(), "Expected expValue instanceof int"));
                }
    ...
    static final class UseEvaluatedNodeFactory implements NodeFactory<UseEvaluatedNode> {
        ...
        private abstract static class UseEvaluatedBaseNode extends UseEvaluatedNode {
            ...
            @SuppressWarnings("unused")
            protected Object executeAndSpecialize0(int minimumState, VirtualFrame frameValue, Object exp0Value, Object exp1Value, String reason) {
                neverPartOfCompilation();
                String message = createInfo0(reason, exp0Value, exp1Value);
                if (minimumState < 1 && SIMPLETYPES.isInteger(exp0Value) && SIMPLETYPES.isInteger(exp1Value)) {
                    int exp0ValueCast = SIMPLETYPES.asInteger(exp0Value);
                    int exp1ValueCast = SIMPLETYPES.asInteger(exp1Value);
                    return this.replace(new UseEvaluatedIntNode(this), message).call(exp0ValueCast, exp1ValueCast);
                }
                return this.replace(new UseEvaluatedGenericNode(this), message).executeGeneric0(exp0Value, exp1Value);
            }
        ...
        private static final class UseEvaluatedUninitializedNode extends UseEvaluatedBaseNode {
            ...
            public Object execute(VirtualFrame frameValue) {
                ...
                return super.executeAndSpecialize0(0, frameValue, exp0Value, exp1Value, "Uninitialized monomorphic");
            }
        ...
        private static final class UseEvaluatedIntNode extends UseEvaluatedBaseNode {
            ...
            public int executeInt(VirtualFrame frameValue) throws UnexpectedResultException {
                ...
                try {
                    ...
                    return SIMPLETYPES.expectInteger(executeAndSpecialize0(1, frameValue, ex.getResult(), exp1Value, "Expected exp0Value instanceof int"));
                }
                int exp1Value;
                try {
                    ...
                    transferToInterpreter();
                    return SIMPLETYPES.expectInteger(executeAndSpecialize0(1, frameValue, exp0Value, ex.getResult(), "Expected exp1Value instanceof int"));
                }
        ...
        private abstract static class DoubleEvaluatedBaseNode extends DoubleEvaluatedNode {
            ...
            protected Object executeAndSpecialize0(int minimumState, VirtualFrame frameValue, Object exp0Value, Object exp1Value, String reason) {
                ...
                if (minimumState < 1 && SIMPLETYPES.isInteger(exp0Value) && SIMPLETYPES.isInteger(exp1Value)) {
                    int exp0ValueCast = SIMPLETYPES.asInteger(exp0Value);
                    int exp1ValueCast = SIMPLETYPES.asInteger(exp1Value);
                    return this.replace(new DoubleEvaluatedIntNode(this), message).doExecuteWith(exp0ValueCast, exp1ValueCast);
                }
                return this.replace(new DoubleEvaluatedGenericNode(this), message).executeGeneric0(exp0Value, exp1Value);
            }
    ...
    static final class UseDoubleEvaluatedNodeFactory implements NodeFactory<UseDoubleEvaluatedNode> {
        ...
        private abstract static class UseDoubleEvaluatedBaseNode extends UseDoubleEvaluatedNode {
            ...
            @SuppressWarnings("unused")
            protected Object executeAndSpecialize0(int minimumState, VirtualFrame frameValue, Object exp0Value, Object exp1Value, Object exp2Value, String reason) {
                neverPartOfCompilation();
                String message = createInfo0(reason, exp0Value, exp1Value, exp2Value);
                if (minimumState < 1 && SIMPLETYPES.isInteger(exp0Value) && SIMPLETYPES.isInteger(exp1Value) && SIMPLETYPES.isInteger(exp2Value)) {
                    int exp0ValueCast = SIMPLETYPES.asInteger(exp0Value);
                    int exp1ValueCast = SIMPLETYPES.asInteger(exp1Value);
                    int exp2ValueCast = SIMPLETYPES.asInteger(exp2Value);
                    return this.replace(new UseDoubleEvaluatedIntNode(this), message).call(exp0ValueCast, exp1ValueCast, exp2ValueCast);
                }
                return this.replace(new UseDoubleEvaluatedGenericNode(this), message).executeGeneric0(exp0Value, exp1Value, exp2Value);
            }
        ...
        private static final class UseDoubleEvaluatedUninitializedNode extends UseDoubleEvaluatedBaseNode {
            ...
            public Object execute(VirtualFrame frameValue) {
                ...
                return super.executeAndSpecialize0(0, frameValue, exp0Value, exp1Value, exp2Value, "Uninitialized monomorphic");
            }
        ...
        private static final class UseDoubleEvaluatedIntNode extends UseDoubleEvaluatedBaseNode {
            ...
            public int executeInt(VirtualFrame frameValue) throws UnexpectedResultException {
                ...
                try {
                    ...
                    return SIMPLETYPES.expectInteger(executeAndSpecialize0(1, frameValue, ex.getResult(), exp1Value, exp2Value, "Expected exp0Value instanceof int"));
                }
                int exp1Value;
                try {
                    exp1Value = this.exp1.executeInt(frameValue);
                    ...
                    return SIMPLETYPES.expectInteger(executeAndSpecialize0(1, frameValue, exp0Value, ex.getResult(), exp2Value, "Expected exp1Value instanceof int"));
                }
                int exp2Value;
                try {
                    ...
                    transferToInterpreter();
                    return SIMPLETYPES.expectInteger(executeAndSpecialize0(1, frameValue, exp0Value, exp1Value, ex.getResult(), "Expected exp2Value instanceof int"));
                }
    ...
    @GeneratedBy(TestEvaluatedGeneration.class)
    static final class TestEvaluatedGenerationFactory implements NodeFactory<TestEvaluatedGeneration> {
        ...
        @Override
        public TestEvaluatedGeneration createNode(Object... arguments) {
            if (arguments.length == 1 && (arguments[0] == null || arguments[0] instanceof ValueNode)) {
                return create((ValueNode) arguments[0]);
            } else {
                throw new IllegalArgumentException("Invalid create signature.");
        ...
        @Override
        public TestEvaluatedGeneration createNodeGeneric(TestEvaluatedGeneration thisNode) {
            return createGeneric(thisNode);
        }

        @Override
        public Class<TestEvaluatedGeneration> getNodeClass() {
            return TestEvaluatedGeneration.class;
        }
        ...
        static TestEvaluatedGeneration createGeneric(TestEvaluatedGeneration thisNode) {
            return new TestEvaluatedGenerationGenericNode((TestEvaluatedGenerationBaseNode) thisNode);
        }

        static TestEvaluatedGeneration create(ValueNode exp0) {
            return new TestEvaluatedGenerationUninitializedNode(exp0);
        }

        static NodeFactory<TestEvaluatedGeneration> getInstance() {
        ...
        @GeneratedBy(TestEvaluatedGeneration.class)
        private abstract static class TestEvaluatedGenerationBaseNode extends TestEvaluatedGeneration {

            @Child protected ValueNode exp0;

            TestEvaluatedGenerationBaseNode(ValueNode exp0) {
                super();
                this.exp0 = adoptChild(exp0);
            }

            TestEvaluatedGenerationBaseNode(TestEvaluatedGenerationBaseNode copy) {
                this.exp0 = adoptChild(copy.exp0);
            }

            @SuppressWarnings("unused")
            protected Object executeAndSpecialize0(int minimumState, VirtualFrame frameValue, Object exp0Value, String reason) {
                neverPartOfCompilation();
                String message = createInfo0(reason, exp0Value);
                if (minimumState < 1 && SIMPLETYPES.isInteger(exp0Value)) {
                    int exp0ValueCast = SIMPLETYPES.asInteger(exp0Value);
                    return this.replace(new TestEvaluatedGenerationIntNode(this), message).call(exp0ValueCast);
                }
                return this.replace(new TestEvaluatedGenerationGenericNode(this), message).executeGeneric0(exp0Value);
            }

            @SlowPath
            protected Object executeGeneric0(Object exp0Value) {
                if (SIMPLETYPES.isInteger(exp0Value)) {
                    int exp0ValueCast = SIMPLETYPES.asInteger(exp0Value);
                    return super.call(exp0ValueCast);
                }
                throw new UnsupportedOperationException(createInfo0("Unsupported values", exp0Value));
            }

            protected static String createInfo0(String message, Object exp0Value) {
                if (DetailedRewriteReasons) {
                    StringBuilder builder = new StringBuilder(message);
                    builder.append(" (");
                    builder.append("exp0Value").append(" = ").append(exp0Value);
        ...
        @GeneratedBy(TestEvaluatedGeneration.class)
        @NodeInfo(kind = Kind.UNINITIALIZED)
        private static final class TestEvaluatedGenerationUninitializedNode extends TestEvaluatedGenerationBaseNode {

            TestEvaluatedGenerationUninitializedNode(ValueNode exp0) {
                super(exp0);
            }
            ...
            public Object execute(VirtualFrame frameValue) {
                transferToInterpreter();
                Object exp0Value = this.exp0.execute(frameValue);
                return super.executeAndSpecialize0(0, frameValue, exp0Value, "Uninitialized monomorphic");
            }

            @Override
            public int executeEvaluated4(VirtualFrame frameValue, int exp0ValueEvaluated) throws UnexpectedResultException {
                int exp0Value = exp0ValueEvaluated;
                return SIMPLETYPES.expectInteger(this.executeEvaluated2(frameValue, exp0Value));
            }

            @Override
            public Object executeEvaluated2(VirtualFrame frameValue, int exp0ValueEvaluated) {
                transferToInterpreter();
                Object exp0Value = exp0ValueEvaluated;
                return super.executeAndSpecialize0(0, frameValue, exp0Value, "Uninitialized monomorphic");
            }
            ...
            @Override
            public int executeEvaluated3(VirtualFrame frameValue, Object exp0ValueEvaluated) throws UnexpectedResultException {
                int exp0Value;
                try {
                    exp0Value = SIMPLETYPES.expectInteger(exp0ValueEvaluated);
                } catch (UnexpectedResultException ex) {
                    transferToInterpreter();
                    return SIMPLETYPES.expectInteger(executeAndSpecialize0(0, frameValue, ex.getResult(), "Expected exp0Value instanceof int"));
                }
                return SIMPLETYPES.expectInteger(this.executeEvaluated2(frameValue, exp0Value));
            }

            @Override
            public Object executeEvaluated1(VirtualFrame frameValue, Object exp0ValueEvaluated) {
                transferToInterpreter();
                Object exp0Value = exp0ValueEvaluated;
                return super.executeAndSpecialize0(0, frameValue, exp0Value, "Uninitialized monomorphic");
            }
        ...
        @GeneratedBy(TestEvaluatedGeneration.class)
        @NodeInfo(kind = Kind.SPECIALIZED)
        private static final class TestEvaluatedGenerationIntNode extends TestEvaluatedGenerationBaseNode {

            TestEvaluatedGenerationIntNode(TestEvaluatedGenerationBaseNode copy) {
                super(copy);
            }
            ...
            public int executeInt(VirtualFrame frameValue) throws UnexpectedResultException {
                ...
                try {
                    ...
                    transferToInterpreter();
                    return SIMPLETYPES.expectInteger(executeAndSpecialize0(1, frameValue, ex.getResult(), "Expected exp0Value instanceof int"));
                }
                return super.call(exp0Value);
            }
            ...
            public Object executeEvaluated2(VirtualFrame frameValue, int exp0ValueEvaluated) {
                ...
                int value;
                try {
                    value = this.executeEvaluated4(frameValue, exp0Value);
                } catch (UnexpectedResultException ex) {
                    return ex.getResult();
                }
                return value;
            ...
            public Object executeEvaluated1(VirtualFrame frameValue, Object exp0ValueEvaluated) {
                ...
                try {
                    ...
                    transferToInterpreter();
                    return executeAndSpecialize0(1, frameValue, ex.getResult(), "Expected exp0Value instanceof int");
                }
                int value;
                try {
                    value = this.executeEvaluated4(frameValue, exp0Value);
        ...
        @GeneratedBy(TestEvaluatedGeneration.class)
        @NodeInfo(kind = Kind.GENERIC)
        private static final class TestEvaluatedGenerationGenericNode extends TestEvaluatedGenerationBaseNode {

            TestEvaluatedGenerationGenericNode(TestEvaluatedGenerationBaseNode copy) {
                super(copy);
            }
            ...
            public Object execute(VirtualFrame frameValue) {
                Object exp0Value = this.exp0.execute(frameValue);
                return super.executeGeneric0(exp0Value);
            }
            ...
            public int executeEvaluated3(VirtualFrame frameValue, Object exp0ValueEvaluated) throws UnexpectedResultException {
                ...
                try {
                    ...
                    transferToInterpreter();
                    return SIMPLETYPES.expectInteger(executeAndSpecialize0(2, frameValue, ex.getResult(), "Expected exp0Value instanceof int"));
                }
                return SIMPLETYPES.expectInteger(this.executeEvaluated2(frameValue, exp0Value));
            }
