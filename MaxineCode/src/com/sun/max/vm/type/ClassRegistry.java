...
import com.sun.max.vm.actor.holder.EnclosingMethodInfo;
import com.sun.max.vm.actor.holder.HybridClassActor;
...
import static com.sun.max.vm.jdk.JDK.ClassRef;
...
public final class ClassRegistry {
    ...
    public static final TupleClassActor CLEANER = createClass(sun.misc.Cleaner.class);
