...
public abstract class HostedClassLoader extends ClassLoader {
    ...
    public void setClasspath(Classpath classpath) {
        ProgramWarning.check(this.classpath == null,
                             "overriding hosted boot class loader's classpath: old value=\"" + this.classpath +
                             "\", new value=\"" + classpath + "\"");
    ...
    private ClassActor defineLoadedClassActor(Class javaClass) throws ClassNotFoundException {
        ...
        return ClassfileReader.defineClassActor(name, this, classpathFile.contents, null, classpathFile.classpathEntry,
                                                false);
    }
     ...
     */
    private Class<?> findArrayClass(final String name,
                                    final TypeDescriptor elementTypeDescriptor) throws ClassNotFoundException {
        ...
        if (this == HostedBootClassLoader.HOSTED_BOOT_CLASS_LOADER &&
            elementClassActor.classLoader == HostedVMClassLoader.HOSTED_VM_CLASS_LOADER) {
            throw new ClassNotFoundException();
        }
    ...
    protected synchronized Class<?> loadClass(final String name, final boolean resolve) throws ClassNotFoundException {
        ...
        Class javaType = null;
        javaType = definedClasses.get(name);
        if (javaType == null) {
            try {
    ...
    public ClassActor makeClassActor(String name) throws ClassNotFoundException {
        ...
        if (classActor == null) {
            ...
            if (arrayElementTypeDescriptor != null) {
                ...
                if (classpathFile != null) {
                    return ClassfileReader.defineClassActor(name, this, classpathFile.contents, null,
                                                            classpathFile.classpathEntry, false);
                }
                throw new ClassNotFoundException(name);
            } else {
