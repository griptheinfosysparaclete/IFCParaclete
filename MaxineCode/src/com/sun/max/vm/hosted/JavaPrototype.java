...
import static com.sun.max.annotate.LOCAL_SUBSTITUTION.Static.toSubstituteeName;
...
import com.sun.max.config.PackageLoader;
import com.sun.max.lang.Classes;
import com.sun.max.program.Classpath;
import com.sun.max.program.ProgramError;
import com.sun.max.program.Trace;
import com.sun.max.vm.HostOnlyClassError;
import com.sun.max.vm.Log;
import com.sun.max.vm.MaxineVM;
import com.sun.max.vm.OmittedClassError;
...
import com.sun.max.vm.classfile.constant.NameAndTypeConstant;
...
public final class JavaPrototype extends Prototype {
    ...
    public Method toJava(MethodActor methodActor) {
        ...
        Log.println("In toJava: " + javaMethod);
        if (javaMethod == null) {
        ...
        Log.println("Leaving toJava: " + javaMethod);
        return javaMethod;
    }
