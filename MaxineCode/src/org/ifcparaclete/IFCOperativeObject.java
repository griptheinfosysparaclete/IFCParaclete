...
class IFCOperativeObject implements IFCStatics {
    ...
    private IFCOperativeObject() {
        super();
    }

    public IFCOperativeObject(Element ifcRunnableObjectElement) {
        super();
    ...
    public static void main(String[] args) {
        IFCOperativeObject ifcRunnableObject = new IFCOperativeObject();
    }
}
